...
Si no se usa el requirements.txt original, instalar al menos: sqlalchemy, psycopg2-binary, pandas, matplotlib, python-dotenv, streamlit.
...
Las tablas originales (raw) deben estar previamente cargadas en el esquema public (scripts del Avance 1). Avance_1_Informe
...
Analizar métodos de pago más utilizados. Avance 4 – Documentación y stor…

Documentación de los avances
En la carpeta Avance_X/docs/ se incluyen los informes en Word/PDF que documentan cada etapa:

Avance 1 – Modelado inicial, carga y EDA. Avance_1_Informe

Avance 2 – Modelado dimensional (hechos y dimensiones). Avance_2_Modelado_de_datos

Avance 3 – Implementación con dbt y validaciones. Avance_3_Informe_dbt

Avance 4 – DBT Docs y storytelling con Streamlit. Avance 4 – Documentación y stor…
